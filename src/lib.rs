...
pub fn mangled_symbol_to_ast(mangled_symbol: &str) -> Result<ast::Symbol, String> {
    parse::Parser::parse(mangled_symbol.as_bytes())
}

/// Generates the demangled version of a symbol name's AST.
pub fn ast_to_demangled_symbol(symbol_ast: &ast::Symbol, verbose: bool) -> String {
    ast_demangle::AstDemangle::demangle(symbol_ast, verbose)
}
